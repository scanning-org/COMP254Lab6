...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap(int cap, double lf, int p) {
    prime = p;
    capacity = cap;
    loadFactor = lf;
  ...
  public AbstractHashMap(int cap, double lf) {
    this(cap, lf,109345121);
  }  // default prime

  /** Creates a hash table with capacity 17 and prime factor 109345121. */
  public AbstractHashMap(double lf) { this(17, lf); } // default capacity
